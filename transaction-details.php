<?php
// Get the transaction hash from the query parameters in the URL.
$queryHash = $_GET['query_hash'];

// Set your Etherscan API key.
$apiKey = '1RI5XYK14NB3M1G31NDI8INGSGIN2M8DAH';

// Construct the API URL with the provided transaction hash and API key.
$apiUrl = "https://api.etherscan.io/api?module=account&action=txlistinternal&txhash=0x40eb908387324f2b575b4879cd9d7188f69c8fc9d87c901b9e2daaea4b442170&apikey=$apiKey";
...
// Extract the transaction data from the API response and store it in the $transactions variable.
										...
										<table class="table table-responsive-md mb-0">
											...
											<tbody>
                                                ...
                                                foreach ($transactions as $transaction) {
                                                    ...
                                                    echo '<td>' . substr($queryHash,0,10) . '...</td>';
